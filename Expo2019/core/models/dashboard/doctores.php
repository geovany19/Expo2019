...
class Doctores extends Validator
{
	...
	{
		$sql = 'SELECT id_doctor, nombre_doctor, apellido_doctor, correo_doctor, usuario_doctor, fecha_nacimiento, foto_doctor, id_estado , nombre_especialidad FROM doctores INNER JOIN especialidad USING(id_especialidad) ORDER BY apellido_doctor';
		$params = array(null);
