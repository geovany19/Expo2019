...
class Usuarios extends Validator
{
	...
	{
		$sql = 'SELECT id_usuario, nombre_usuario, apellido_usuario, correo_usuario, usuario_usuario, fecha_nacimiento, foto_usuario FROM usuarios_a ORDER BY apellido_usuario';
		$params = array(null);
