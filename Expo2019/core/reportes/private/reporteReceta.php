...
require_once('../../models/private/usuarios.php');
  ...
  //  $pdf->date();
    ...
    $pdf->date();            
        ...
        $pdf->Ln(0.5);
        $pdf->Cell(35,10, utf8_decode('Nombres paciente:'),'',0,'B',true);
        $pdf->Cell(15,10, utf8_decode($data[$last]['nombre_paciente']),'',0,'C',true);
        $pdf->Cell(15,10, utf8_decode($data[$last]['apellido_paciente']),'',1,'C',true);
        $pdf->Ln(10); 
