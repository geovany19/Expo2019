    ...
    <div class="modal-content">
	  ...
	  <form class="needs-validation" id="form-create" novalidate>
			...
			<div class="col-md-6 mb-4">
				...
				<select id="create_doctor" name="create_doctor">
				</select>
			</div>			
			<div class="col-md-6 mb-4">
				<label for="create_paciente">Seleccione el Paciete</label>
				<select id="create_paciente" name="create_paciente">
				</select>
			</div>
			<div class="col-md-6 mb-4">
			...
			<div class="col-md-6 mb-4">
      			...
      			<input type="Time" class="form-control" id="create_hora" name="create_hora" required>
    		</div>
			</div>
    ...
    <div class="modal-content">
	  ...
	  <input type="hidden" id="id_cita" name="id_cita">
			...
			<div class="col-md-6 mb-4">
				...
				<select id="update_doctor" name="update_doctor">
				</select>
			</div>			
			<div class="col-md-6 mb-4">
				<label for="update_paciente">Seleccione el Paciete</label>
				<select id="update_paciente" name="update_paciente">
				</select>
			</div>
			<div class="col-md-6 mb-4">
			...
			<div class="col-md-6 mb-4">
      			...
      			<input type="Time" class="form-control" id="update_hora" name="update_hora" required>
    		</div>
			</div>
			<div class="modal-footer">
				<button type="button" data-toggle="tooltip" data-placement="top" title="Cancelar" class="btn btn-danger" data-dismiss="modal"><i class="material-icons prefix">cancel</i></button>
